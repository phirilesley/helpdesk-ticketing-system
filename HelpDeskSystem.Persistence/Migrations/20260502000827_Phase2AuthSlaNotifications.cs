...
{
    /// <inheritdoc />
    public partial class Phase2AuthSlaNotifications : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreachType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BreachedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
...
BEGIN
    ...
    INSERT INTO [Tenants] ([Id], [Name], [Domain], [IsActive], [CreatedAtUtc], [UpdatedAtUtc], [IsDeleted])
    VALUES (1, 'Default Tenant', 'default.local', 1, SYSUTCDATETIME(), NULL, 0);
